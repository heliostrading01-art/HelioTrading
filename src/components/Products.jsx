                    ...
                    <div className="e-con-inner">
                      ...
                      <div className="elementor-element elementor-element-0885d55 e-con-full e-flex e-con e-child" data-id="0885d55" data-element_type="container">
                        ...
                        <div className="elementor-element elementor-element-3389ca4 e-con-full e-flex e-con e-child" data-id="3389ca4" data-element_type="container">
                          <div className="elementor-element elementor-element-ac95fa9 de_scroll_animation_no elementor-widget elementor-widget-rating" data-id="ac95fa9" data-element_type="widget" data-widget_type="rating.default">
                            <div className="elementor-widget-container">
                              <div className="e-rating" role="img" aria-label={`Rated ${product.rating} out of 5`}>
                                <div className="e-rating-wrapper">
                                  {Array.from({ length: 5 }).map((_, i) => (
                                    <div key={i} className="e-icon">
                                      <div className="e-icon-wrapper e-icon-marked">
                                        <i aria-hidden="true" className="icon_star"></i>
                                      </div>
                          ...
                          <div className="elementor-element elementor-element-53e775b de_scroll_animation_no elementor-widget elementor-widget-text-editor" data-id="53e775b" data-element_type="widget" data-widget_type="text-editor.default">
                            <div className="elementor-widget-container">
                              {product.rating}
                            </div>
                          </div>
